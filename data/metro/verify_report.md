...
| 本資料系統數 | 265 |
| 站數相符 (ok) | 202 |
| 標記待查 | 34（missing 2／no_line 0／order 3／zero 0／low 2／high 27） |
| 額外（不在 wiki 清單） | 52 |
...
4. **站序必須正確**：**3** 個系統有站序可疑的線（severity `order`）——一律以該線 **Wikipedia 條目**的車站列表與 **urbanrail.net** 的線路站序人工確認
...
| order | Alexandria | Egypt | 61 | — | — | 2 條線站序可疑（路徑長 > 1.6× MST）：El Nasr 6 2.4×、Alexandria Passenger Transportation Authority 1.76×，需以 Wikipedia 線路條目與 urbanrail 人工確認站序 | [urbanrail](https://www.google.com/search?q=site%3Aurbanrail.net%20Alexandria) |
| order | Adelaide | Australia | 123 | — | — | 4 條線站序可疑（路徑長 > 1.6× MST）：Outer Harbor Line 2.13×、Flinders Line 1.88×、Train PTDOCK 1.85×、Train BEL 1.67×，需以 Wikipedia 線路條目與 urbanrail 人工確認站序 | [urbanrail](https://www.google.com/search?q=site%3Aurbanrail.net%20Adelaide) |
...
| metro-maps/africa/egypt/af-egy-alexandria.geojson | Alexandria | Egypt | 61 | 5 |
