...
{ "algo":"hccells-v1", "fingerprint":"…",
  ...
  "loops": { "rect": { "cellAfter":[…], "cols":n, "rows":n, "stats":{…} }, … } }`,
    ...
    algorithm: `<p>Straighten 圖層為 <b>原始-形狀／旋轉-形狀</b>。左選單直接進 <b>直線演算法</b>（已無「初步直線化」比較區）；爬山在背後當輸入。規定表城市可在 ⑨形狀計算跑 LLM 成方——<b>有成方則餵下游並凍結方形</b>；無成方＝舊管線。按「重新計算圖層」會清空成方，需再開 ⑨ tab 重算。</p>
