...
{ "W":200, "H":150,
  ...
  hillclimb: {
    title: 'Straighten（形狀圖層）', tag: '視圖',
    skills: ['route-hillclimb', 'route-shape-align', 'route-llm-shape'],
    svg: dHc, caption: '形狀圖層：可選成方 → 爬山 → 直線演算法。',
    mapping: [
...
{ "algo":"hccells-v1", "fingerprint":"…",
  ...
  "loops": { "rect": { "cellAfter":[…], "cols":n, "rows":n, "stats":{…} }, … } }`,
    ...
    algorithm: `<p>Straighten 圖層為 <b>原始-形狀／旋轉-形狀</b>。左選單直接進 <b>直線演算法</b>（已無「初步直線化」比較區）；爬山在背後當輸入。規定表城市可在 形狀計算 跑 LLM 成方——<b>有成方則餵下游並凍結方形</b>；無成方＝舊管線。按「重新計算圖層」會清空成方，需再開 形狀計算 tab 重算。</p>
