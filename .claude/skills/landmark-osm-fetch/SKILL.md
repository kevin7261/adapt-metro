...
| eu-aut-vienna | 河流骨架 | river-centerline | Donau 27.9／Neue Donau 22.1／Donaukanal 17.5 km 三條 |
...
1. **`rivers: [names]` 河流骨架**：抓 OSM 人工維護的河道中心線——
   ...
   - 支流不進名單就不會出現（River Lea/馬恩河/蘇州河/磺溪…天然排除）；同城多條
     水道（維也納 Donau/Neue Donau/Donaukanal）就開多個名單項，各成一條骨架。
